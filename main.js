...
document.querySelector(".input-screen").addEventListener('change', function (event)  {
...
document.querySelector(".btn-coffee-order").addEventListener("click", function(event) {
...
function addOrderToList() {
    ...
    li.appendChild(document.createTextNode(orderList[orderList.length-1].totalPrice));

    li.appendChild(document.createTextNode(". Number of coffees You have ordered is: "));

    li.appendChild(document.createTextNode(orderList[orderList.length-1].numberOfCoffees));

    li.appendChild(document.createTextNode(". Current status of order is: "));

    li.appendChild(document.createTextNode(orderList[orderList.length-1].status));
